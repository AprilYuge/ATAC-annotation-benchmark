...
class TrainingProcessStage3():
    def __init__(self, config, output_folder='./output/'):
        ...
        self.train_rna_loaders, self.test_rna_loaders, self.train_atac_loaders, self.test_atac_loaders, self.training_iters = PrepareDataloader(config, output_folder).getloader()
    ...
    def write_embeddings(self, output_path='output/'):
        ...
        for i, rna_loader in enumerate(self.test_rna_loaders):
            ...
            fp_em = open(output_path + db_name + '_embeddings.txt', 'w')
        ...
        for i, atac_loader in enumerate(self.test_atac_loaders):
            ...
            fp_em = open(output_path + db_name + '_embeddings.txt', 'w')
            fp_pre = open(output_path + db_name + '_predictions.txt', 'w')
