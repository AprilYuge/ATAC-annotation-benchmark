...
def main():    
    ...
    adata = SCALEX(data_list=[rna, atac], outdir=result_folder, ignore_umap=True, min_features=0, min_cells=0,
                   normalize_samples=False, log_normalize=False,  batch_categories=['RNA', 'ATAC'])
